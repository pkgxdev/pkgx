...
//import { findTeaPrefix } from "hooks/useConfig.ts"

// FIXME: do this in apply config
// doing here as this is the only file all our scripts import
//set_tmp(findTeaPrefix(new Path(Deno.execPath()), Deno.env.get("TEA_PREFIX")).join('tea.xyz/tmp'))
